...
export const getWeekTodos = async (date) => {
  try {
    ...
    const response = await axios.get(`${API_BASE_URL}/week/${formattedDate}`);
    return response.data;
  } catch (error) {
...
export const updateTodo = async (todoId, updateData) => {
  try {
    const response = await axios.put(`${API_BASE_URL}/${todoId}`, updateData);
    return response.data;
  } catch (error) {
...
export const updateTodoStatus = async (todoId, status) => {
  try {
    const response = await axios.patch(`${API_BASE_URL}/${todoId}/status`, { status });
    return response.data;
  } catch (error) {
